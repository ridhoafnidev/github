package com.dailyapps.consumenapp.receiver
...
import com.dailyapps.consumenapp.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun showAlarmNotification(context: Context, message: String?) {
        val channelId = "ChannelGithub"
        val channelName ="DailyNotification"
        ...
        val builder = NotificationCompat.Builder(context, channelId)
            .setSmallIcon(R.drawable.ic_baseline_access_alarms)
