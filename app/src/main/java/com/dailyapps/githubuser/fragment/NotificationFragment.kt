...
import com.dailyapps.githubuser.databinding.FragmentNotificationBinding
import com.dailyapps.githubuser.receiver.AlarmReceiver
...
class NotificationFragment : Fragment() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if(item.itemId == android.R.id.home){
            val homeFragment = NotificationFragmentDirections.actionNotificationFragmentToHomeFragment()
