package com.dailyapps.githubuser.provider
...
import com.dailyapps.githubuser.db.DatabaseContract.AUTHORITY
import com.dailyapps.githubuser.db.DatabaseContract.FavColumns.Companion.CONTENT_URI
import com.dailyapps.githubuser.db.DatabaseContract.FavColumns.Companion.TABLE_NAME
import com.dailyapps.githubuser.db.FavoriteHelper

class GithubtProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, s: String?, strings: Array<String>?): Int {
        ...
        val deleted: Int = when (FAV_ID) {
            sUriMatcher.match(uri) -> favHelper.deleteById(s)
            else -> 0
        }
